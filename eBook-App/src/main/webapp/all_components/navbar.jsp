	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active"><a class="nav-link" href="#"> <i
					class="fas fa-house-chimney"></i> Home <span class="sr-only">(current)</span></a>
			</li>
			...
			<li class="nav-item active"><a class="nav-link disabled"><i
					class="fa-solid fa-book-open"></i> Old Books</a></li>
		</ul>
		...
		<form class="form-inline my-2 my-lg-0">
			...
			<button class="btn btn-light my-2 my-sm-0 ml-1" type="submit">
				<span class="fa-solid fa-address-book" aria-hidden="true"></span>Contact
				Us
			</button>
		</form>
	</div>
